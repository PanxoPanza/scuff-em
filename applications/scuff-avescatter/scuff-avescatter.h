...
/*
* scuff-avescatter		-- a standalone code within the scuff-em suite
*						-- for implementing the fluctuating-surface-current
*						-- approach for average scattering calculations of
*						-- random oriented particles (more specifically,
*						-- for absorption and scattering cross section,
*						-- asymmetry parameter)
 *
 * Francisco Ramirez	-- 10/2020
 */
#ifndef SCUFFAVESCATTER_H
#define SCUFFAVESCATTER_H
...
// Hemispherical average scattering (F. Ramirez 2020)
#define SCUFF_AVSCAT_EMT 10
#define NUM_AVSCAT 3
#define EXTERIOR_INDEX	 0
#define AV_SCATTERING	-1
#define AV_ASYM_X		-4
#define AV_ASYM_Y		-3
#define AV_ASYM_Z		-2
#define NUM_ASYM		 3
...
typedef struct SNEQData
 {
   ...
   // neq scattering calculations (Francisco Ramirez 2019)
   HMatrix *T0;    // Scattering matrix
   HMatrix **dT0;  // Scattering Matrix gradient
